...
IL_0039:
	...
	}
	{
		...
		NullCheck(L_11);
		(L_11)->SetAt(static_cast<il2cpp_array_size_t>(L_13), (KeyValuePair_2_t8F108A4B1A3AC521BB64612B42799E049A2F202C)L_20);
	}
...
IL_007f:
	{
		...
		NullCheck(L_19);
		uint8_t L_21;
		L_21 = KeyValuePair_2_get_Key_m280595C31B288539ED9AF3927E28FACA802BF437_inline(((L_19)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_20))), il2cpp_rgctx_method(method->klass->rgctx_data, 22));
		goto IL_009a;
	}
...
IL_009a:
	{
		...
		NullCheck(L_22);
		uint8_t L_24;
		L_24 = KeyValuePair_2_get_Key_m280595C31B288539ED9AF3927E28FACA802BF437_inline(((L_22)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_23))), il2cpp_rgctx_method(method->klass->rgctx_data, 22));
		KeyValuePair_2U5BU5D_tFD6CE6AFD122439891F50861CB1246F737618C49* L_25 = V_3;
		int32_t L_26 = V_4;
		NullCheck(L_25);
		int32_t L_27;
		L_27 = KeyValuePair_2_get_Value_mFA78EA2DE8D3F737EE78CCC20259506C1C857896_inline(((L_25)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_26))), il2cpp_rgctx_method(method->klass->rgctx_data, 24));
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t Dictionary_2_EnsureCapacity_m09465B47964B49A2682F75EB4E3D9971AA3D3EA6_gshared (Dictionary_2_t661FE742B263C55D84EA95C0A49C9B0327F21D7B* __this, int32_t ___0_capacity, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL_000b:
	{
		EntryU5BU5D_tE9DC85530A5D20A47B4DBAD9550CB62B57478CB8* L_1 = __this->____entries;
		if (!L_1)
		{
			goto IL_001d;
		}
...
IL_0025:
	...
	}
	{
		int32_t L_7 = ___0_capacity;
		int32_t L_8;
		L_8 = Dictionary_2_Initialize_mF8B8FD438249C8057F680ED46B8185FB03FB0B7F(__this, L_7, il2cpp_rgctx_method(method->klass->rgctx_data, 2));
		return L_8;
	}
...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_mFFDEB4F717A3D5DE98F1B1A2A47900202A2FB2E4(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 54));
		int32_t L_12 = V_1;
		return L_12;
	}
}
...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_m3AA3AE68DA106D282A49A24D371A22778DEC54B0(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 54));
		int32_t L_12 = V_1;
		return L_12;
	}
}
...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_mDA2C2B2AA9D036744EA1510458F902ACF49E6658(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 54));
		int32_t L_12 = V_1;
		return L_12;
	}
}
