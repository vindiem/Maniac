...
IL_0047:
	...
	try
	{
		...
		}
		{
			...
			L_25 = VirtualFuncInvoker1< MethodInfoU5BU5D_tDF3670604A0AECF814A0B0BA09B91FBF0D6A3265*, int32_t >::Invoke(98, L_23, L_24);
			V_12 = L_25;
			V_13 = 0;
...
IL_023c:
	{
		...
		NullCheck(L_83);
		bool L_86;
		L_86 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(121, L_83, L_85);
		V_18 = L_86;
		bool L_87 = V_18;
		if (!L_87)
		{
...
IL_025e:
	{
		...
		NullCheck(L_88);
		bool L_91;
		L_91 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(121, L_88, L_90);
		V_19 = L_91;
		bool L_92 = V_19;
		if (!L_92)
		{
